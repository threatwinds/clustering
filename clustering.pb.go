...
func file_clustering_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_clustering_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_clustering_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Ping); i {
			case 0:
				return &v.state
			case 1:
		...
		file_clustering_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
		...
		file_clustering_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
